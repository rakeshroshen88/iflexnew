...
//header('Location: http:///index.php');/**    Getting the directory name   */
 $_DIR_PATH =  str_replace("\\","/",dirname(__FILE__))."/";
	...
	$_TBL_COMPANY="company_page";
	$_TBL_USER="all_user";
	$_TBL_TEMPORDER="temp";
	$_TBL_PROD="products";
	$_TBL_SUBSUBCAT="subsubcategory";
	$_TBL_SUBCAT="subcategory";
	$_TBL_ORDER="user_order";
	$_TBL_BILL="billing_address";
	$_TBL_PROD1="product";
	$_TBL_COUNTRIES="country";
	...
	$_TBL_STATE="state";
	$_TBL_FACI="facility";
	$_TBL_HOTELLIST="hotellist";
	$_TBL_SIGHT="sight";
	$_TBL_ITEMIMAGE="image";
	$_TBL_HOTEL="hotel";	
	$_TBL_ART="article";
	$_TBL_AMENITIES="amenities";
	/** Directories **/
