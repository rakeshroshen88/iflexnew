...
$sqlp="SELECT * from user_post where FIND_IN_SET(".$_SESSION['sess_webid'].",tagfriends) or user_id='".$_SESSION['sess_webid']."' or user_id IN($allfriends) or user_id IN($allfriend1) and post_hide='0' order by post_id desc limit 0,1";
$dbp->query($sqlp);
if($dbp->numRows()>0)
{
				                    ...
				                    <div class="contact contact-rounded contact-lg">
				                        ...
				                        <div class="contact-container">
				                            ...
				                            <div class="replycommnetbt">
												...
												<a href="javascript:void(0)" id="deletecomment" class="deletecomment"><i class="delet-icon fa fa-trash-o"></i></a>
												<a href="javascript:void(0)" id="editcomment" class="editcomment" ><i class="edit-icon fa fa-pencil"></i></a>
								           	</div>
				                        </div>
				                    </div>
					...
					<div class="form newpostcomments">
	                    <div class="form-group">
	                        	...
	                        	<form id="" method="post">
													...
													<div class="input-group-btn">
														<button type="button" id="commentid<?=$row['post_id']?>" class="commentid btn btn-default" cid="<?=$row['post_id']?>"><i class="fa fa-send"></i></button>
													</div>
													</div>
                                                ...
                                                <?php ///////////current city/////////////?>
                                                    <div class="row">
                                                        ...
                                                        <section class="mb-4">
                                                            ...
                                                            <!--Section description-->
                                                            <h3 class="text-center w-responsive mx-auto mb-5 query-head">Do you have any query? Please do not hesitate to contact us directly. Our team will come back to you within
...
<input type="hidden" id="send2" name="send2" value="send2">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="md-form mb-0">
                                                                                    <input type="text" id="name" name="name" placeholder="Your name" class="form-control" style="
    margin-bottom: 10px;">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="md-form mb-0">
                                                                                    <input type="text" id="email" name="email" placeholder="Your email" class="form-control" style="
    margin-bottom: 10px;">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="md-form mb-0">
                                                                                    <input type="text" id="subject" name="subject" placeholder="Subject" class="form-control" style="
    margin-bottom: 10px;">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="md-form mb-0">
                                                                                    <input type="text" id="mobileno" name="mobileno" placeholder="Mobile no"class="form-control" style="
    margin-bottom: 10px;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="md-form">
                                                                                    <textarea type="text" id="message" name="message" rows="2" placeholder="Your message" class="form-control md-textarea" style="margin-bottom: 10px;"></textarea>
                                                                    ...
                                                                    <div class="text-center text-md-left" style="padding:15px;">
                                                                        <a class="btn btn-primary query-send" onclick="document.getElementById('contact-form').submit();">Send</a>
                                                                    </div>
	...
	<?php }?>
					...
					?>
                                                <div class="feedbackbox bg-white full-width">
