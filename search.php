                            ...
                            <div class="main-ws-sec">
                                ...
                                <div class="product-feed-tab current" id="saved-jobs">
                                    ...
                                    <div class="tab-content" id="myTabContent">
										...
										$db7=new DB();
										$q=$_POST['searchpage'];
										 $sql="select * from all_user where first_name like '%$q%' or last_name like '%$q%' GROUP BY user_id ";
		  ...
		  <?php if(!empty($cityrow['current_city'])){ ?>                                                                             <li><img src="images/icon9.png" alt=""><span><?=$cityrow['current_city']?></span></li>
		   <?php }?>
							...
							$f_id=$db5->getSingleResult("SELECT f_id from followers where user_id = '".$_SESSION['sess_webid']."' or follow=".$cityrow['user_id']);
									...
									<?php }else{ ?>
														<div class="devepbtn appliedinfo noreply">
                                                                            <a class="clrbtn sendreequest"  id="sendreequest<?=$cityrow['user_id']?>" fid="<?=$cityrow['user_id']?>" href="javascript:void(0);"> Add as a Friend</a>
                                                                        </div>
									<?php } ?>									
                                                                    </div>
                                                                </div>
